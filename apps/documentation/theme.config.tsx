...
const themeConfig: DocsThemeConfig = {
  logo: <span>Justx</span>,
  head: function useHead() {
    const config = useConfig();

    const title = `${config.frontMatter.title} | Justx Docs` || 'Justx Docs';
    const description = config.frontMatter.description || 'Documentação oficial Justx';
