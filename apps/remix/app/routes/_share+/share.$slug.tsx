...
export function meta({ params: { slug } }: Route.MetaArgs) {
  ...
  return [
    { title: 'JustX - Share' },
    { description: 'I just signed a document in style with JustX!' },
    {
      property: 'og:title',
      content: 'JustX - Join the open source signing revolution',
    },
    {
      property: 'og:description',
      content: 'I just signed with JustX!',
    },
    {
      property: 'og:type',
      content: 'website',
...
export const loader = async ({ request, params: { slug } }: Route.LoaderArgs) => {
  ...
  // Is hardcoded because this whole meta is hardcoded anyway for JustX.
