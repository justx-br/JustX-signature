...
export const SignUpForm = ({
  ...
  return (
    <div className={cn('flex w-full justify-center', className)}>
      <div className="relative z-10 flex w-full max-w-md flex-col items-center rounded-xl border border-border bg-neutral-100 p-8 shadow-lg dark:bg-background">
